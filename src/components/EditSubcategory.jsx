  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Edit Subcategory</h1>
          <p className="text-sm text-gray-500">Update subcategory details, parent association, and media</p>
        </div>
      </div>
