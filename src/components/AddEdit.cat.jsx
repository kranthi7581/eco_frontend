...
const AddCategory = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Generate and append slug from name
      const generatedSlug = formData.name
        ? formData.name.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)+/g, "")
        : "";
      categoryData.append("slug", generatedSlug);
      ...
      await api.post(`${CATEGORY_API}/categories`, categoryData, {
        headers: {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Add Category</h1>
          <p className="text-sm text-gray-500">Create a new category with media details</p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-6">
            ...
            <div>
              ...
              <textarea
                rows="4"
                placeholder="e.g. Gadgets, devices, and accessories..."
